...
{
    public partial class Consulta_Carro : Form
    {
        public Consulta_Carro()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand sqlQuery = new MySqlCommand("SELECT * FROM carro", conexao);
        ...
        private void Consulta_Carro_Load(object sender, EventArgs e)
        {
